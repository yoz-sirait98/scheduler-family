  ...
  <div class="space-y-5 max-w-4xl mx-auto">
    ...
    <div class="flex items-center justify-between gap-3">
      <div>
        ...
        <p class="text-xs text-slate-500 dark:text-slate-400 mt-0.5">
          Manage, search, and filter all personal and family tasks
        </p>
      </div>
    ...
    <div class="flex flex-col sm:flex-row items-center gap-2.5">
      ...
      <div class="relative w-full flex-1">
        ...
        <input
          ...
          class="w-full pl-10 pr-4 py-2.5 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 text-xs shadow-xs"
        />
        <button
      ...
      <div class="flex items-center gap-1.5 self-end sm:self-auto shrink-0 w-full sm:w-auto">
        ...
        <select
          ...
          class="w-full sm:w-auto px-3 py-2 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-xs text-slate-700 dark:text-slate-300 focus:outline-none focus:ring-2 focus:ring-indigo-500"
        >
    ...
    <div class="flex items-center gap-1.5 overflow-x-auto pb-1 no-scrollbar">
      <button
        ...
        class="px-3.5 py-1.5 rounded-xl text-xs font-semibold whitespace-nowrap transition-all border shrink-0"
    ...
    <div class="flex items-center gap-1.5 overflow-x-auto pb-1 no-scrollbar">
      <button
        ...
        class="px-3 py-1 rounded-full text-xs font-medium border transition-all shrink-0"
      ...
      <button
        ...
        class="flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-medium border transition-all shrink-0"
